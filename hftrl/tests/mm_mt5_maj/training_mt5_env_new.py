...
from hftrl.rllib.callbacks.eval_functions import custom_eval_function
...
project_path = '/home/mora/Documents/projects/HFTRL/hftrl/tests/mm_mt5_maj/'
...
cfg_mm_mt5 = ConfigMarketMakingEnv(
    action_space = MultiDiscrete([20,20]),
